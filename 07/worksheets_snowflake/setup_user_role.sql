...
CREATE USER IF NOT EXISTS extract_loader2
    PASSWORD = 'KJ8vemQ3bk!!!!' -- create a password and fill in here
...
GRANT ROLE job_ads_dlt_role TO USER extract_loader2;
...
GRANT ROLE job_ads_dlt_role TO USER ERIKUNEVIK;
